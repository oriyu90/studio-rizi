...
const projects = [
  ...
  {name:'Tango pro',url:'https://studio-rizi.pages.dev/projects/tango-pro/',repository:'https://github.com/oriyu90/Tango-pro',releaseDate:'2026.06.02',releaseVersion:'v1.0.1',releaseSource:'github-release',code:'TP',description:{ja:'自分のCSVで続けられる単語帳アプリ。',en:'A vocabulary app built around your own CSV.',zh:'使用自己的 CSV 持续学习单词。',pt:'Um app de vocabulário feito para o seu CSV.'},platforms:['Android','macOS'],color:'lime'},
