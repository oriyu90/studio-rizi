...
const projects = [
  ...
  {name:'Humi',url:'https://studio-rizi.pages.dev/projects/humi/',repository:'https://github.com/oriyu90/humi',releaseDate:'2026.08.28',releaseVersion:'v1.1.0',releaseSource:'github-release',code:'HM',description:{ja:'ターミナルをタイルで並べる macOS アプリ。',en:'Arrange terminal sessions as tiles on macOS.',zh:'把终端会话平铺排列的 macOS 应用。',pt:'Organize sessões de terminal em blocos no macOS.'},platforms:['macOS'],color:'lime'},
