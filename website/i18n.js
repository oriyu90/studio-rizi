(function () {
  ...
  const pages = {
    home:{
      ja:{hero:'世界をもっと、<br><em>便利に</em><br>面白く',lead:'誰もがその便利さ、面白さにふれる機会があるように。<br>そんな世界を目指して、開発をしています。',projects:'プロジェクトを見る <span>→</span>',profile:'プロフィール <span>↘</span>',j:['考えたことを、<br>言葉にする。','作っている人を、<br>もっと知る。','新しい動きは<br>ここから'],ptitle:'つくったもの、<br><em>育てているもの。</em>',plead:'音楽、学習、AI、ファイル管理。日常の小さな不便を見つけ、使える形までつくります。カードを選ぶと詳細が開きます。',news:'お知らせ',all:'すべてのお知らせを見る <span>→</span>',closing:'次の「便利」と「面白い」を、<br><em>つくり続ける。</em>'},
